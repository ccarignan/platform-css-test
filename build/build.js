...
var steps = {
    ...
    uikit: () => util.compile('src/js/aqkit.js', 'dist/js/aqkit', {minify, bundled: true}),
    icons: () => util.write('dist/icons.json', util.icons('{node_modules/uikit/src/images,src}/icons/*.svg'))
        .then(() => util.compile('src/js/icons.js', 'dist/js/aqkit-icons', {
            minify,
            name: 'icons',
